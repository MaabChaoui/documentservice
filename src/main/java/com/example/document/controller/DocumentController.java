...
import com.example.document.dto.DocumentMetadataRequest;  // Import this class
...
public class DocumentController {
    ...
    public Document updateMetadata(@PathVariable Long id, @RequestBody DocumentMetadataRequest request) {
        return documentService.updateMetadata(id, request);  // Ensure you're passing DocumentMetadataRequest
    }
